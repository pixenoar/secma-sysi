<div wire:ignore.self class="modal fade" id="modalCreatePregunta" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalCreatePreguntaLabel" aria-hidden="true">
            ...
            <form wire:submit.prevent="preStore">
                ...
                <div class="modal-footer @if(session()->has('message')) border-top border-success border-3 @endif">
                    ...
                    <button type="submit" class="btn btn-primary" wire:target="preStore" wire:loading.class="disabled">
                        ...
                        <div wire:loading wire:target="preStore">Guardando...</div>
                    </button>
                </div>
            </form> 
        </div>
