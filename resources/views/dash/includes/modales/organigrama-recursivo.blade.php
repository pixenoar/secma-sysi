<li class="py-1">
    <a href="#" wire:click="selSector({{ $sector->id }})" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="@if($moUsuario) #modalEdit @else #modalCreate @endif">{{ $sector->nombre }}</a>
</li>
